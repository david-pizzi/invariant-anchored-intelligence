...
Write-Host "✓ IAI modules found in shared/iai_core" -ForegroundColor Green
...
if ($existingApp) {
    Write-Host "✓ Function app exists - will update" -ForegroundColor Yellow
} else {
...
Write-Host "  1. Test V3: curl https://$FunctionAppName.azurewebsites.net/api/dashboard" -ForegroundColor White
